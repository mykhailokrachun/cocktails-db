...
[CocktailsDB](https://mykhailok-cocktails-db.netlify.app/)
...
- Clone the repository using `git clone https://github.com/mykhailokrachun/cocktails-db.git`
- Change directory into the project folder: `cd cocktails-db`
- Run `npm install`
- Run `npm start`
